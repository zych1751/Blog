            ...
            <form onSubmit={preventEvent}>
              <div className="control-group">
                <div className="form-group floating-label-form-group controls">
                  ...
                  <p className="help-block text-danger">
                    { usernameFail ? {usernameFail} : null }
                  </p>
                </div>
              </div>
              ...
              <div className="control-group">
                <div className="form-group floating-label-form-group controls">
                  ...
                  />
                  <p className="help-block text-danger">
                    { passwordCheckFail ? {passwordCheckFail} : null }
                  </p>
                </div>
              </div>
              ...
              <div className="control-group">
                <div className="form-group floating-label-form-group controls">
                  ...
                  />
                  <p className="help-block text-danger">
                    { emailFail ? {emailFail} : null }
                  </p>
                </div>
              </div>
              <br />
              <div className="form-group">
                <button className="btn btn-primary" onClick={()=>this.handleRegister()}>회원가입</button>
              </div>
            </form>
          </div>
        </div>
